...
*/
template< int SIZE >
class YCAPI MemPoolT : public MemPool
{
public:
...
*/
class YCAPI XMLText : public XMLNode
{
...
/** An XML Comment. */
class YCAPI XMLComment : public XMLNode
{
	friend class XMLDocument;
public:
...
*/
class YCAPI XMLDeclaration : public XMLNode
{
	friend class XMLDocument;
public:
...
*/
class YCAPI XMLUnknown : public XMLNode
{
	friend class XMLDocument;
public:
...
*/
class YCAPI XMLElement : public XMLNode
{
	friend class XMLBase;
	friend class XMLDocument;
public:
...
*/
class YCAPI XMLDocument : public XMLNode
{
	friend class XMLElement;
public:
	/// constructor
