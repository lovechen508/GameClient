 ...
 * context.
*/
void YCMD5::MD5Update (unsigned char *input,unsigned int inputLen)
{
 ...
 */
void YCMD5::MD5Final (unsigned char digest[16])
{
 ...
 */
void YCMD5::MD5Transform (unsigned long int state[4], unsigned char block[64])
{
 ...
 */
void YCMD5::Encode (unsigned char *output, unsigned long int *input,unsigned int len)
{
	unsigned int i, j;
 ...
 */
void YCMD5::Decode (unsigned long int *output, unsigned char *input, unsigned int len)
{
	unsigned int i, j;
 ...
 */
void YCMD5::MD5_memcpy (unsigned char* output, unsigned char* input,unsigned int len)
{
	unsigned int i;
 ...
 */
void YCMD5::MD5_memset (unsigned char* output,int value,unsigned int len)
{
	unsigned int i;
