#ifndef _INCLUDE_YCTIMEPERFORMANCE_H_
#define _INCLUDE_YCTIMEPERFORMANCE_H_

#include <ctime>

class YCAPI YCTimePerformance
{

public: 
	
	// everything is public for ease of access
	// begin/end variables
	clock_t Begin;
	clock_t End;
